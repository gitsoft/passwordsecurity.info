(function (doc) {
    ...
    var renderChecks = function (checks, input) {
        ...
        for (var i = 0, l = checks.length; i < l; i++) {
            ...
            title.className = "c64pm px16";
            title.innerHTML = checks[i].name;
            li.className = "c64pm px16";
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          if (xhttpresponse.indexOf(subsha1pass) !== -1) {
            document.getElementById("iscompromised").innerHTML = '<img src="img/mario_fail.gif"><br><span style="color: #ff0000;" class="c64pm px16">Oh no! This password was found in the database for stolen credentials.</h4></span><br><span style="color: #ff0000;" class="c64pm px16">Having a stolen (publicly known) password is dangerous. Change it without delay.</h4></span>';
          }else {
            document.getElementById("iscompromised").innerHTML = '<span style="color: #339966;" class="c64pm px16"><img src="img/mario_success.gif"><br>Good news, this password has never been breached!</span>';
          }
        }else {
          if (this.status == 404) {
            document.getElementById("iscompromised").innerHTML = '<span style="color: #339966;" class="c64pm px16">Good news, this password has never been breached!</span>';
          }
        }
      };
...
function passwordmodified() {
  ...
  if (modifiedpassword !== passwordplain) {
    document.getElementById("iscompromised").innerHTML = '<span style="color: #ff9900;" class="c64pm px16"><img src="img/loading.gif" alt="" width="25" height="25" />&nbsp;We are checking if your password has ever been compromised...</span>';
  }
}
